...
const testimonials: { img: StaticImageData; clientImg: StaticImageData; name: string; company: string; content: string; categories: number[] }[] = [];
...
//     name: "Rajesh K.",
//     company: "Retail Store Owner, Madurai",
//     content:
//       "Village Story’s POS system significantly improved our billing speed and stock tracking. GST reports are clear, and daily closing is now hassle-free.",
//     categories: [1, 3],
//   },
//   {
...
//     name: "Suresh M.",
//     company: "Restaurant Manager, Ramanathapuram",
//     content:
//       "The KOT and kitchen display system reduced order confusion completely. Everything flows automatically from billing to kitchen.",
//     categories: [1, 5],
//   },
//   {
...
//     name: "Anitha R.",
//     company: "Manufacturing Unit, Tamil Nadu",
//     content:
//       "We use the ERP modules for purchase, sales, and accounts. Reports are accurate and tailored to Indian compliance needs.",
//     categories: [1, 4],
//   },
//   {
...
//     content:
//       "The system is modular and cost-effective. We started small and added more ERP modules as our business grew.",
//     categories: [1, 4, 3],
//   },
//   {
...
//     content:
//       "Village Story’s built our web and mobile app exactly as required. Communication was clear, and delivery was on time.",
//     categories: [1, 2],
//   },
//   {
...
//     name: "Karthik P.",
//     company: "Multi-Branch Retail Chain",
//     content:
//       "Multi-location POS syncing and centralized reports helped us control operations better without increasing staff workload.",
//     categories: [1, 3],
//   },
// ];
