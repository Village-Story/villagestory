...
export default function Cta() {
  ...
  {/* <div data-aos="fade-up" data-aos-delay={400}>
    <a
      ...
      text-white shadow-[inset_0px_1px_0px_0px_--theme(--color-white/.16)]
  ...
  {/* <div data-aos="fade-up" data-aos-delay={600}>
    <a
      ...
      text-gray-300 before:pointer-events-none before:absolute before:inset-0
      ...
      hover:bg-[length:100%_150%] sm:ml-4 sm:w-auto"
    >
